...
insert  into `profile`(`userid`,`langpref`,`favcategory`,`mylistopt`,`banneropt`) values ('ACID','english','CATS',1,1),('j2ee','English','DOGS',1,1),('yangyong','English','FISH',1,0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 MAX_ROWS=1000 COMMENT='cadastro de usu�rios';

/*Data for the table `signon` */

insert  into `signon`(`username`,`password`) values ('ACID','ACID'),('j2ee','j2ee'),('yangyong','1234');
